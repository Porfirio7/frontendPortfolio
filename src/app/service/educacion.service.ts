...
export class EducacionService {
  ...
  /*eduURL = 'http://localhost:9000/educacion/';*/

  eduURL = 'https://backendportfolioale2.onrender.com/educacion/';
  ...
  public detail(id: number): Observable<Educacion>{
    return this.httpClient.get<Educacion>(this.eduURL + `detalles/${id}`)
  }
